...
const Header = () => {
  ...
  return (
    <>
      {
            isMobile?(
              <div className=" fixed top-0 right-5 w-[6rem] rounded-lg  z-50 object-cover overflow-auto">
            <Link href="/">
              <Image
                src="/logo_svg_1.svg"
                alt="logo"
                width={80}
                height={40}
                className="w-[6rem] h-[6rem]  rounded-lg bg-transparent scale-100 hover:scale-110 transition-transform duration-500 ease-in-out   md:mr-2"
                priority={true}
              />
            </Link>
          </div>
